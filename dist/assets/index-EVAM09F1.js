...
function generateCartContentHTML(cartDesignPublications) {
  let output = "";
  for (let i = 0; i < cartDesignPublications.length; i++) {
    ...
    for (let j = 0; j < cartDesignPublications[i].length; j++) {
      ...
      output += '<img onclick="fullScreen(this)" src="' + publication.imageURL + '" alt="' + publication.title + '">';
    }
    output += "</div>";
  }
  return output;
...
window.data = {
  ...
  catalog: {
    1: {
      ...
      imageURL: "https://cms-imgp.jw-cdn.org/img/p/g/202511/O/pt/g_O_202511_lg.jpg"
    },
    2: {
      title: "Waar is het respect gebleven?",
      imageURL: "https://cms-imgp.jw-cdn.org/img/p/g/202411/O/pt/g_O_202411_lg.jpg"
    },
    3: {
      title: "Is er hoop voor onze planeet?",
      imageURL: "https://cms-imgp.jw-cdn.org/img/p/g/202311/O/pt/g_O_202311_lg.jpg"
    }
  }
};
window.session = {
